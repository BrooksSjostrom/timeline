...
var $author$project$EventList$unitDict = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
          A3($author$project$Types$Event, 'Germanic general Odoacer deposes Romulus Augustulus, last Western Emperor', 476, 'No description.'),
          A3($author$project$Types$Event, 'Theodoric becomes king of the Ostrogoths', 483, 'No description.'),
          A3($author$project$Types$Event, 'Death of Theodoric', 526, 'No description.'),
          A3($author$project$Types$Event, 'Justinian’s general Belisarius defeats Vandals and reconquers N. Africa', 534, 'No description.'),
          A3($author$project$Types$Event, 'T’ang Dynasty founded in China', 618, 'No description.'),
          A3($author$project$Types$Event, 'hijra of Muhammad from Mecca to Medina', 622, 'No description.'),
          A3($author$project$Types$Event, 'Muslim conquest of Syria', 636, 'No description.'),
          A3($author$project$Types$Event, 'Muslim conquest of Iraq', 637, 'No description.'),
          A3($author$project$Types$Event, 'Muslim conquest of Egypt', 642, 'No description.'),
          A3($author$project$Types$Event, 'Muslim Caliph ‘Umar murdered', 644, 'No description.'),
          A3($author$project$Types$Event, 'Muslim Caliph ‘Uthman assassinated', 656, 'No description.'),
          A3($author$project$Types$Event, '‘Ali murdered (revolt led by him against Caliphate ends)', 661, 'No description.'),
          A3($author$project$Types$Event, 'Muslim conquest of Spain', 711, 'No description.'),
          A3($author$project$Types$Event, 'Battle of Tours halts Muslim expansion into Europe', 733, 'No description.'),
          A3($author$project$Types$Event, 'Muslims defeat Chinese near Samarkand (capture Chinese papermakers)', 751, 'No description.'),
          A3($author$project$Types$Event, 'Spain establishes independent Umayyad Caliphate', 756, 'No description.')
				])),
			_Utils_Tuple2(
			'II',
			_List_fromArray(
